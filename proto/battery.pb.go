...
type Session struct {
	...
	MId  uint32            `protobuf:"varint,1,opt,name=MId,proto3" json:"MId,omitempty"`                                                                                          // message id build by client
	Data map[string]string `protobuf:"bytes,2,rep,name=Data,proto3" json:"Data,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // extend data
}
...
var file_battery_proto_rawDesc = []byte{
	...
	0x05, 0x61, 0x63, 0x74, 0x6f, 0x72, 0x22, 0x82, 0x01, 0x0a, 0x07, 0x53, 0x65, 0x73, 0x73, 0x69,
	0x6f, 0x6e, 0x12, 0x10, 0x0a, 0x03, 0x4d, 0x49, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52,
	0x03, 0x4d, 0x49, 0x64, 0x12, 0x2c, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61, 0x18, 0x02, 0x20, 0x03,
	0x28, 0x0b, 0x32, 0x18, 0x2e, 0x61, 0x63, 0x74, 0x6f, 0x72, 0x2e, 0x53, 0x65, 0x73, 0x73, 0x69,
	...
	0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x63, 0x6f, 0x6c, 0x69, 0x6e, 0x31,
	0x39, 0x38, 0x39, 0x2f, 0x62, 0x61, 0x74, 0x74, 0x65, 0x72, 0x79, 0x2f, 0x70, 0x72, 0x6f, 0x74,
...
var file_battery_proto_goTypes = []interface{}{
	(*Session)(nil), // 0: actor.Session
	nil,             // 1: actor.Session.DataEntry
}
var file_battery_proto_depIdxs = []int32{
	1, // 0: actor.Session.Data:type_name -> actor.Session.DataEntry
